...
let toySchema = new mongoose.Schema({
  ...
  price:Number,
  img_url:{
    type:String, default:"https://st.depositphotos.com/1987177/3470/v/950/depositphotos_34700099-stock-illustration-no-photo-available-or-missing.jpg"
  },
  date_created:{
    type:Date, default:Date.now()
  },
    // יכיל את האיי די של המשתמש שהוסיף את הרשומה
    user_id:String
